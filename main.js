...
td1.innerHTML = td_ertek1 //megadom a változó nevét amiben az adat van 
...
td2.innerHTML = td_ertek2//megadom a változó nevét amiben az adat van 
...
td3.innerHTML =td_ertek3 //megadom a változó nevét amiben az adat van 
...
td4.innerHTML = td_ertek4//megadom a változó nevét amiben az adat van 
...
td5.innerHTML = td_ertek5//megadom a változó nevét amiben az adat van 
...
td6.innerHTML = td_ertek6//megadom a változó nevét amiben az adat van 
...
td7.innerHTML = td_ertek7//megadom a változó nevét amiben az adat van 
...
td8.innerHTML = td_ertek8//megadom a változó nevét amiben az adat van 
...
td9.innerHTML =td_ertek9 //megadom a változó nevét amiben az adat van 
...
td10.innerHTML = td_ertek10//megadom a változó nevét amiben az adat van 
...
td11.innerHTML =td_ertek11 //megadom a változó nevét amiben az adat van 
...
td12.innerHTML = td_ertek12//megadom a változó nevét amiben az adat van 
...
td13.innerHTML = td_ertek13//megadom a változó nevét amiben az adat van 
...
td14.innerHTML = td_ertek14//megadom a változó nevét amiben az adat van 
...
td15.innerHTML = td_ertek15//megadom a változó nevét amiben az adat van 
...
td16.innerHTML = td_ertek16//megadom a változó nevét amiben az adat van 
